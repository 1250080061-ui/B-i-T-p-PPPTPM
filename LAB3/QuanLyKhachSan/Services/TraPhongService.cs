            ...
            DateTime ngayTra)
        {
            ...
            using (var tx = cn.BeginTransaction())
            {
                try
                {
                    ...
                    // Chưa thanh toán đủ thì không trả phòng
                    if (tt != "Đã thanh toán")
                    {
                        return KetQuaXuLy.Fail(
